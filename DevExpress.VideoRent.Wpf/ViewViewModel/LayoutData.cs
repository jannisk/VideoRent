...
namespace DevExpress.VideoRent.Wpf {
    public class WpfLayoutData : LayoutData {
        ...
        static void OnLayoutManagerBeforeSave(object sender, EventArgs e) {
            GetLayoutData().ApplicationThemeName = ThemeSelector<ApplyingThemeSplashScreenWindow>.Current.Theme.Name;
        }
        static void OnLayoutManagerAfterLoad(object sender, EventArgs e) {
            ThemeSelector<ApplyingThemeSplashScreenWindow>.Current.Theme = Theme.FindTheme(GetLayoutData().ApplicationThemeName);
        }
