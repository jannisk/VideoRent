...
namespace DevExpress.VideoRent.ViewModel {
    public class Announcer : ModuleObjectDetailBase {
        ...
        void DoCommandDownload(object p) { ObjectHelper.ShowWebSite("https://www.devexpress.com/ClientCenter/Downloads/#Trials"); }
        public Action<object> CommandBuy { get { return DoCommandBuy; } }
        void DoCommandBuy(object p) { ObjectHelper.ShowWebSite("https://www.devexpress.com/ClientCenter/Purchase/"); }
        #endregion
